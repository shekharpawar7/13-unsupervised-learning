"""A Mobile Phone manufacturing company wants to launch its three brand new 
 phone into the market, but before going with its 
 traditional marketing approach this time it want to analyze the data 
 of its previous model sales in different regions and you have been hired 
 as an Data Scientist to help them out, use the Association rules concept 
 and provide your insights to the company’s marketing team to improve its sales.
"""

'''
Business Objective:
    
maximize: Identify the previous markert trrend and make a product .

Minimize: company reputation and increae the product sale

Constraints: increase product sale and help in the making of new mobile phone .
...
df=pd.read_csv("c:/4-DataSets/myphonedata.csv")
df.shape
#the dataset having a 11 row and 6 columns
v=df.describe()
df.info()
